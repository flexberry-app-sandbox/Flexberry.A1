...
namespace IIS.A1
{
    ...
    public class ЗаказПокуп : IIS.A1.ОтчетОПродажах
    {
        ...
        public override IIS.A1.СостОплаты СостОплат
        {
            get
            {
                ...
                IIS.A1.СостОплаты result = base.СостОплат;
        ...
        public override IIS.A1.СостОгрузки СостОтгруз
        {
            get
            {
                ...
                IIS.A1.СостОгрузки result = base.СостОтгруз;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЗаказПокупE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаказПокупE", typeof(IIS.A1.ЗаказПокуп));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЗаказПокупL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаказПокупL", typeof(IIS.A1.ЗаказПокуп));
                }
            }
        }
    }
